...
public class SerialNumber extends javax.swing.JPanel {
    ...
    CarHistory history;
    private Car car;
    public SerialNumber(CarHistory history) {
        initComponents();
    ...
    private void initComponents() {
        ...
        tblRecords.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Car Name", "Manufacturer", "Location", "Model Number", "Travel Company", "Year manufactured", "Seats", "Valid Maintenance", "Available"
            }
        ) {
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(serial, javax.swing.GroupLayout.PREFERRED_SIZE, 295, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void populateRecords(String serialNum) {
         DefaultTableModel model = (DefaultTableModel) tblRecords.getModel();
        model.setRowCount(0);
        
        for(Car car: history.getHistory()){
            Object[] row = new Object[9];
            if(car.getNumberPlate().toLowerCase().equals(serialNum.toLowerCase())){
            row[0] = car;
